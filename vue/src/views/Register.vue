  ...
  <main id="registerMain">
    <div class="wrapper">
      <form>
        ...
        <button-component size="large" variant="primary" class="cta" @click="register">Zarejestruj się</button-component>
      </form>

      <span class="text-body-small">
        Masz już konto? <router-link to="/lgoowanie">Zaloguj się</router-link>
      </span>
